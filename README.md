...
**Evidência:** [ct-02-1.png](evidencias/ct-02-1.png) , [ct-02.png](evidencias/ct-02.png)  
...
**Evidência:** [ct-03.png](evidencias/ct-03.png)  
...
**Evidência:** [ct-05-1.png](evidencias/ct-05-1.png) , [ct-05.png](evidencias/ct-05.png)  
...
**Resultado esperado:** A digitação deve respeitar estritamente o limite di caracteres da máscara padrão DD/MM/AAAA.  
...
* **Então** o sistema deve exibir la mensagem abaixo do campo “Data” informando que não são permitidos agendamentos aos domingos
...
**Resultado esperado:** O seletor de horários deve exibir como desabilitado ou indisponível o horário que já possui um agendamento confirmado.  
...
**Evidências:** [ct-02-1.png](evidencias/ct-02-1.png) , [ct-02.png](evidencias/ct-02.png)  
...
**📝 Descrição:** Ao interagir com o campo "Telefone", o sistema aceita a digitação di caracteres alfabéticos (letras), espaços livres e caracteres especiais que não pertencem à formatação padrão da máscara telefônica.
