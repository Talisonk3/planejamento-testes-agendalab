...
Navegador utilizado: Google Chrome (Versão 149.0.7827.197 (Versão oficial) 64 bits)

BDD: O BDD é uma prática de desenvolvimento de software que visa integrar as regras de negócio com a especificação técnica e os testes. Ele utiliza uma linguagem natural, simples e estruturada para descrever como o sistema deve se comportar do ponto de vista do usuário final.
...
•	CT-11: Validar aviso de impedimento de agendamento aos domingos
...
•	Regra de Negócio de Agendamento e Sucesso
